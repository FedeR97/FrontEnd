...
import com.portfolio.FAR.Dto.dtoPersona;
import com.portfolio.FAR.Entity.Persona;
import com.portfolio.FAR.Security.Controller.Mensaje;
import com.portfolio.FAR.Service.ImpPersonaService;
...
public class PersonaController {
    ...
    */
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoPersona dtopersona){
        ...
        return new ResponseEntity(new Mensaje("Datos actualizada"),HttpStatus.OK);
    }
